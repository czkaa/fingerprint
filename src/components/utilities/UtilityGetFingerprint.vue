  ...
  methods: {
    ...
    webgl() {
      var canvas,
        ...
        width = 256,
        height = 128;
      canvas = this.$refs.canvasContainer.appendChild(
      ...
      if (
        this.fingerprints.some(
          (fingerprint) => fingerprint.string == this.fingerprint.string
        )
      ) {
        console.log("yeyyy");
        this.fingerprint = this.fingerprints.find(
          (o) => o.string === this.fingerprint.string
        );
      } else {
